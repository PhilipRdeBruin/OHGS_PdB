...
<script>
    ...
    function procesturn(turn) {
        ...
        // // console.log("rol, beurt, len_Arr = " + rol + ", " + beurt + ", " + l);

        // if (l >= 0) {
        //     tp = statusArr2[l][0];
        //     beurt = statusArr2[l][1];

        //     console.log("rol, tp, beurt, len_Arr = " + rol + ", " + tp + ", " + beurt + ", " + l);
        //     if (beurt == 0) {
        //         if (rol == "codemaster") {
        //             document.getElementById("kleurenpalet").style.visibility = "hidden";
        //             console.log(rol + ": kleurenpalet.vis = " + document.getElementById("kleurenpalet").style.visibility);
        //         } else {
        //             document.getElementById("knop1").style.visibility = "visible";
        //             document.getElementById("kleurenpalet").style.visibility = "visible";
        //             document.getElementById("kleurenpalet").style = "margin-top:0";
        //             console.log(rol + ": knop1.vis = " + document.getElementById("knop1").style.visibility);
        //         }
        //     } else {
        //         h = 45 * beurt;
        //         bvis = (rol == "codemaster") ? "visible" : "hidden";
        //         bhid = (rol == "codemaster") ? "hidden" : "visible";
        //         document.getElementById("knop" + beurt).style.visibility = "hidden";
        //         if (beurt < 10) {
        ...
        //         rol = (rol == "codemaster") ? "codekraker" : "codemaster";
